...
export const routeHandler = async (
  ...
  const { body: hubsIds, dbService, loggedUser, query }: { body: any; dbService: DbService; loggedUser: User, query: any } = req
  // const { id } = query
  ...
  // get BoLHub from id
  const { result, insertedIds} = await dbService.copyMultipleHubsById(hubsIds)
